...
import { tabularNums, Theme } from '../../src/theme/theme';
...
const styles = StyleSheet.create({
  ...
  statValue: { fontSize: 19, fontWeight: '900', marginTop: 3 },
  ...
  placeLabel: { fontSize: 16, fontWeight: '800' },
  placeSub: { fontSize: 12, fontWeight: '600', marginTop: 2 },
  matchRow: { paddingVertical: 11, gap: 4 },
  matchTop: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  oppName: { flex: 1, fontSize: 14, fontWeight: '700' },
  matchScore: { fontSize: 14, fontWeight: '800' },
  matchMeta: { fontSize: 11, fontWeight: '600' },
  scorers: { fontSize: 12, fontWeight: '600' },
